...
import { GetFactura, UpdRecieve } from '../api/api';
                    ...
                    <Box px="4" pt="4">
                        <HStack space={4} style={{ display: 'flex', justifyContent: 'space-between', width: "100%" }}>
                            ...
                            <HStack style={{ fontFamily: "PoppinsMedium", flex: 2 }}>
                                ...
                                {cant ? <Checkbox accessibilityLabel="Revisado" isChecked _disabled={true} style={{ backgroundColor: 'white', borderColor: '#72DFB1' }} _icon={{ color: '#72DFB1' }}></Checkbox> : <Checkbox style={{ backgroundColor: 'white', borderColor: '#FFE3C9' }} _invalid={true} accessibilityLabel="Revisado" ></Checkbox>}
                            </HStack>
                        </HStack>
                    </Box>
                    <Box px="4" pb="4">
